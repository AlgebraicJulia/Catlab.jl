...
using ..FinFunctors: mapvals, FinFunctor, FinDomFunctor#, FinDomFunctorMap# , FinTransformation
...
# Instead just Diagram = FinDomFunctor? 
# struct FreeDiagramAsDiagram (implements ThFinDomFunctor)
#   diag::FreeDiagram
#   cat::Category
#   function FreeDiagramAsDiagram(d, c)
#     # check that the type parameters match up
#   end
# end 
