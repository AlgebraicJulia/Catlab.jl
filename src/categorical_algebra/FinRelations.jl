...
module FinRelations
export BoolRig,
  FinRel, FinRelation, FinRelationCallable, FinRelationMatrix, force
...
"""
@auto_hash_equals struct FinRelationCallable{S,S′,T,T′} <:
                         FinRelation{S,S′,T,T′}
...
"""
@auto_hash_equals struct FinRelationMatrix{M<:AbstractMatrix{BoolRig}} <:
                         FinRelation{Int,Int,Int,Int}
  rel::M
end
...
function FinRelationMatrix(
  R::AbstractMatrix{BoolRig},
  dom::FinRel{Int},
  codom::FinRel{Int},
)
