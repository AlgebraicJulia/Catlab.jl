...
"""
Hetromorphism from 𝒞 → 𝒟 where 𝒟 is a coproduct indexed by keys. In this case, the Heteromorphisms must also be indexed. We assume they all share a common domain category 𝒞. In case the list is empty, the 
"""
