export Category2,
  ...
  SymmetricMonoidalDoubleCategory,
...
"""
@theory MonoidalDoubleCategory{Ob,HomV,HomH,Hom2} <:
        DoubleCategory{Ob,HomV,HomH,Hom2} begin
  otimes(A::Ob, B::Ob)::Ob
  ...
  (f ⊗ g) ⊗ h ==
  f ⊗ (g ⊗ h) ⊣
  (A::Ob, B::Ob, C::Ob, X::Ob, Y::Ob, Z::Ob, f::(A↓X), g::(B↓Y), h::(C↓Z))
  ...
  id2H(f ⊗ g) ==
  id2H(f) ⊗ id2H(g) ⊣
  (A::Ob, B::Ob, C::Ob, D::Ob, f::(A↓C), g::(B↓D))
  id2V(f ⊗ g) ==
  id2V(f) ⊗ id2V(g) ⊣
  (A::Ob, B::Ob, C::Ob, D::Ob, f::(A → C), g::(B → D))
end
...
"""
@theory SymmetricMonoidalDoubleCategory{Ob,HomV,HomH,Hom2} <:
        MonoidalDoubleCategory{Ob,HomV,HomH,Hom2} begin
  ...
  # Coherence axioms.
  σV(A, B ⊗ C) ==
  (σV(A, B) ⊗ idV(C)) ⋅ (idV(B) ⊗ σV(A, C)) ⊣
  (A::Ob, B::Ob, C::Ob)
  σV(A ⊗ B, C) ==
  (idV(A) ⊗ σV(B, C)) ⋅ (σV(A, C) ⊗ idV(B)) ⊣
  (A::Ob, B::Ob, C::Ob)
  (
    σH(f, g ⊗ h) ==
    (σH(f, g) ⊗ id2V(h)) ⋅ (id2V(g) ⊗ σH(f, h)) ⊣
    (
      A::Ob,
      B::Ob,
      C::Ob,
