...
@struct_hash_equal struct CallableFunction{DT<:AbsSet,CT<:AbsSet,D,C}
  ...
  function CallableFunction(f, dom::DT, codom::CT)  where {DT<:AbsSet,CT<:AbsSet}
...
@instance ThSetFunction{D,C} [model::CallableFunction{SetOb,SetOb,D,C}] where {D,C} begin
...
SetFunction(f::Function, d::SetOb, c::SetOb) =
