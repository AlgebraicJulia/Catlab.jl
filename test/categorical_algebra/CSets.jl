...
@test length(homomorphisms(s2,s3; loose=(D=x->10*x,)))==1
@test homomorphism(s2,s3; loose=(D=x->10*x,)) isa LooseACSetTransformation
@test length(homomorphisms(s1,s1; loose=(D=x->x^x,)))==4
